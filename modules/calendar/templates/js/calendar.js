...
//----------------
    ...
    $.fn.fillEventForm = function (event) {
        ...
        if (event.repeat_end_date) var repeat_date = event.repeat_end_date.split('-');
        ...
        $('#event-student-id').val((event.student ? event.student:'0'));
...
//----------------
    $.fn.setNewEvent = function () {
      ...
      console.log(Drupal.settings.studentBeforeEvent);
